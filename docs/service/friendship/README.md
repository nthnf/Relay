...
- **identity** as the owner of stable `user_id` references used by friendship records and event payloads, and for synchronous target-user existence validation on write paths.

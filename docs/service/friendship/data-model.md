...
- `gateway` forwards authenticated relationship commands to friendship; friendship does not trust client-supplied actor identity without gateway-provided auth context.

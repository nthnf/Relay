...
export function getBootstrapClient(): BootstrapServiceClient {
	return demoBootstrapClient as unknown as BootstrapServiceClient;
}

export function getChatClient(): ChatServiceClient {
	return demoChatClient as unknown as ChatServiceClient;
}

export function getFriendshipClient(): FriendshipServiceClient {
	return demoFriendshipClient as unknown as FriendshipServiceClient;
}

export function getIdentityClient(): IdentityServiceClient {
	return demoIdentityClient as unknown as IdentityServiceClient;
}

export function getRealtimeClient(): RealtimeServiceClient {
	return demoRealtimeClient as unknown as RealtimeServiceClient;
}

export function getWorkspaceClient(): WorkspaceServiceClient {
	return demoWorkspaceClient as unknown as WorkspaceServiceClient;
}
